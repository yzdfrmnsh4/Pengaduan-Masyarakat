<x-layout>
    <div class=" min-h-screen p-8">
        <div class="max-w-7xl mx-auto">
            <h1 class="text-3xl font-bold text-gray-800 mb-8">Edit Akun Admin</h1>
            <div class="bg-white shadow-lg rounded-lg overflow-hidden border">
                <div class="p-8">
                    <form action="/admin/akun/admin/{{ $yazid_petugas->id_petugas }}" method="POST" enctype="multipart/form-data" novalidate>
                        @csrf
                        @method('put')
                        <div class="space-y-6 ">
