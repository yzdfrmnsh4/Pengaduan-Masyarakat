<x-layout>
    <div class="min-h-screen p-8">
        <div class="max-w-7xl mx-auto">
            ...
            <!-- Search Form -->
            <div class="mb-6">
                <form action="{{ Route('admin.akun.admin') }}" method="GET" class="flex gap-4">
                ...
                <div class="overflow-x-auto">
                    <table class="w-full">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            @forelse($yazid_petugas as $yazid_akun)
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap flex gap-2">
                                        <a href="/admin/akun/admin/edit/{{ $yazid_akun->id_petugas }}" class="text-green-500">
                                        ...
                                        <form action="/admin/akun/admin/{{ $yazid_akun->id_petugas }}" method="post">
                                            @csrf
                                            @method('delete')
                            ...
                            @empty
                                <tr>
                                    <td colspan="6" class="px-6 py-4 text-center text-gray-500">Tidak ada data admin yang ditemukan.</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
