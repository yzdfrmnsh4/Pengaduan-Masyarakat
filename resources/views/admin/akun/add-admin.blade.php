<x-layout>
    <div class=" min-h-screen p-8">
        <div class="max-w-7xl mx-auto">
            <h1 class="text-3xl font-bold text-gray-800 mb-8">Buat Akun Admin</h1>
            <div class="bg-white shadow-lg rounded-lg overflow-hidden border">
                <div class="p-8">
                    <form action="{{ Route('admin.add.store') }}" method="POST" enctype="multipart/form-data" novalidate>
                        @csrf
                        <div class="space-y-6 ">
                            ...
                            <div class="grid grid-cols-2 gap-5">
                                <div>
                                    ...
                                    <input type="text" name="nama_petugas" id="nama_petugas"
                                        value="{{ old('nama_petugas') }}" placeholder="Masukan Nama Petugas" required
                                ...
                                <div>
                                    ...
                                    <input type="text" name="username" id="username" value="{{ old('username') }}"
                                        placeholder="Masukan Username Petugas" required
                                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition duration-300">
                                    @error('username')
                                        <p class="text-red-400 mt-1 text-sm">{{ $message }}</p>
                                    @enderror
                                ...
                                <!-- Phone Number -->
                                <div>
                                    <label for="telp" class="block text-sm font-medium text-gray-700 mb-1">No.
                                        Telepon</label>
